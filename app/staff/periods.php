<?php 
    ...
    $period = callAPI('GET','period/list', false);
    $periodStatus = $period['status'];
    $periodListTotal = $period['list_total'];
    $periodData = $period['response'];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
            ...
            <div class="main-content">
                ...
                <div class="card rounded-lg shadow-1">
                    <div class="card-header">
                        <h5 class="card-title">
                            <span class="icon fa fa-clock-o text-muted"></span>
                    ...
                    <div class="card-body bg-lighter bl-3 border-success p-0">
                        <div class="p-4 d-flex justify-content-between bb-1 border-light">
                            ...
                            <div class="fs-40 fw-100 text-right pr-2 text-success"><?=$periodListTotal?></div>
                        </div>
                    </div><!-- data-provide="datatables" -->
                    <div class="table-responsive">
                        <table class="table table-hover b-0" data-provide="selectall" data-table-url="period">
                            <thead>
                                <tr class="bg-lightest">
                                    ...
                                    <th class="font-weight-bold">Period Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=""><?=$row['period_name']?></td>
                                    <td class=""><?=$row['period_time']?></td>
                                    <td>
        ...
        <div class="fab fab-fixed">
            <a class="btn btn-float btn-primary" href="#dock-new-user" title="" data-provide="tooltip" data-toggle="dock" data-original-title="New Period">
                <i class="ti-plus"></i>
            </a>
        </div>
        <!-- Dock - Add ... -->
        <div class="dock-list">
            <div id="dock-new-user" class="dock dock-sm h-250px">
                ...
                <div class="dock-body dock-block">
                    ...
                    <form class="form-type-material regular-form" data-submit-url="period">  
                        <div class="form-group">
                            <input type="text" class="form-control" name="period_name" id="periodName" required>
                            <label>Period Name</label>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-control" name="period_time" id="periodTime" required>
                            <label>Time</label>
                        </div>
