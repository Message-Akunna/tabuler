<?php 
    ...
    $departmentListTotal = $department['list_total'];
...
<html lang="en">
    ...
    <body>
            ...
            <div class="main-content">
                ...
                <div class="card rounded-lg shadow-1">
                    <div class="card-header">
                        <h5 class="card-title">
                            <span class="icon fa fa-bank text-muted"></span>
                    ...
                    <div class="card-body bg-lighter bl-3 border-success p-0">
                        <div class="p-4 d-flex justify-content-between bb-1 border-light">
                            <div>
                                ...
                                <div class="fs-18 text-primary">Please add Departments before adding courses to courses table.</div>
                            </div>
    
                            <div class="fs-40 fw-100 text-right pr-2 text-success"><?=$departmentListTotal?></div>
                        </div>
                    </div><!-- data-provide="datatables" -->
                    <div class="table-responsive">
                        <table class="table table-hover b-0" data-provide="selectall" data-table-url="department">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=""><?=$row['department_name']?></td>
                                    <td>
        ...
        <div class="fab fab-fixed">
            <a class="btn btn-float btn-primary" href="#dock-new-user" title="" data-provide="tooltip" data-toggle="dock" data-original-title="New Department">
                <i class="ti-plus"></i>
            </a>
        </div>
        <!-- Dock - Add Department -->
            ...
            <div id="dock-new-user" class="dock dock-sm h-200px">
                ...
                <div class="dock-body dock-block">
                    <div class="alert alert-success d-none" id="formAlertSuccess">
                        <span class="">Data Successfully Added, page will refresh in 2 Seconds <i class="fa fa-check-circle"></i>
                        </span>
                    </div>
                    ...
                    <form class="form-type-material regular-form"  data-submit-url="department">    
