<?php
    ...
    //Description: List calender table
    ...
    $listCountSQL = $con->prepare("SELECT count(id) FROM calender $WHERE_CLAUSE $queryCondition");
    ...
    if($listCountSQL->num_rows() >= 1 && $listCountSQL->errno == 0){
        ...
        $listSQL = $con->prepare("SELECT day, id FROM calender $WHERE_CLAUSE $queryCondition $limit");
        $listSQL->execute();
        $listSQL->bind_result( $day, $id);
